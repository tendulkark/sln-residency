  ...
  return (
    <SwitchGroup as="div" className="flex items-center justify-between gap-3">
      <span className="flex flex-col">
        <SwitchLabel as="span" className="text-sm font-medium text-ink-soft">
          {label}
        </SwitchLabel>
      ...
      <HeadlessSwitch
        checked={checked}
        onChange={onChange}
        className={`${checked ? "bg-brand" : "bg-line-strong"} relative inline-flex h-6 w-11 shrink-0 items-center rounded-full transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-ring`}
      >
