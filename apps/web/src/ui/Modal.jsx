...
// Modal (title/onClose/children/wide) —
// backed by Headless UI: focus trap, ESC-to-close, backdrop
// click, and enter/leave transitions come for free.
export default function Modal({ title, actions, onClose, children, wide = false }) {
  return (
