...
import { Button, Combobox, GstCalculator, Input, Select, Switch, Textarea, computeGst, GST_MODE } from "@/ui/index.js";
import Modal from "@/ui/Dialog.jsx";
import { roomsAvailableKey, ROOMS_QUERY_KEY } from "@/modules/rooms/constants.js";
import { guestsKey, BOOKINGS_QUERY_KEY } from "@/modules/reservations/constants.js";
...
const EMPTY_CHARGE_ROW = { description: "", gstAmount: "", gstRate: "", gstMode: GST_MODE.EXCLUDE };
